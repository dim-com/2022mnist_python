...
def load_data():
    ...
    X_valid = X_train[0: num_of_validation, :]
    Y_valid = Y_train[0: num_of_validation]

    return X_train[num_of_validation:, :], Y_train[num_of_validation:, ], X_valid, Y_valid, X_test, Y_test
